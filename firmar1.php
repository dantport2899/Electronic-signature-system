...
<div class="alert alert-success">
                <div class="form-group">
                  <label for="my-input"><h4>Selecciona el Documento que deseas firmar</h4> </label>
                  </div>
...
<?php
        while($arreglo3=mysqli_fetch_array($query3)){
           ...
           echo "<td><a href='firmar1.php?id=$arreglo3[0]&idborrar3=2&documento=$arreglo3[1]'><img src='imagenes/borrar.png' width='20' height='20'></a></td>";
           echo "</tr>";
         }
         echo "</table>";
 ?>
