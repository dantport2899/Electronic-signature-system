...
<div class="row animated fadeIn fast alert alert-success"  id="pla" >
        <div class="col-md-4">
                      <img style="max-width:65%; width:auto; height:auto;" src="imagenes/archivo.jpg"  class="img-img-fluid" >
                      <br><br>
        </div>
        <div class="col-md-8" >
                    <h5 class="card-title">Selecciona el Archivo que desas subir</h5>
                    <hr>
                    ...
                    <br><br>
                    <input type="submit" value="Subir Documento" class="btn float-left login_btn"><a href="">   </a>
